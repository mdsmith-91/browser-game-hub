const GameRegistry = [
  ...
  { id: 'minesweeper', title: 'Minesweeper', description: 'Clear the field without detonating a mine.', icon: 'Mine', url: '/games/minesweeper/', highScoreLabel: 'Best Time (seconds)', singlePlayer: true, localMultiplayer: true, aiOpponent: false, playerCount: '1-2', gameModes: ['Single Player', 'Two Players Duel'] },
